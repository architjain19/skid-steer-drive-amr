...
# *****************************************************************************************
# *  
# Filename:             amr_mapping.launch.py
# Created:              20/03/2024
...
def generate_launch_description():
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(amr_navigation_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    ld.add_action(declare_mapper_online_async_param_cmd)            # Load the online async params file
    ld.add_action(mapper_online_async_param_launch)                 # Launch the online async launch file for mapping
